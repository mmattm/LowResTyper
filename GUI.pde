...
void setupGUI() {
  ...
  cp5.addSlider("scroll_speed").setPosition(20, oy + space*2).setSize(80, 10).setRange(40, 5).setCaptionLabel("Scroll Speed");
  cp5.addToggle("raster").setPosition(20, oy + space*3).setSize(20, 20).setCaptionLabel("Rasterize");
  cp5.addSlider("raster_threshold").setPosition(20, oy + space*4).setSize(80, 10).setRange(255, 50).setCaptionLabel("Threshold");
  ...
  cp5.getController("raster_threshold").getCaptionLabel().hide();
